  ...
  return (
    ...
    >
      <div className="relative w-full md:w-1/3 flex justify-center">
        <Image src="/olo-head.png" alt="BOLO Character Head" width={350} height={350} className="z-10" />{" "}
        {/* Updated alt text */}
      ...
      <div className="relative w-full md:w-2/3 bg-memecoin-blue p-8 md:p-12 rounded-lg shadow-xl border-4 border-white text-center md:text-left">
        ...
        <p className="text-lg text-white mb-6 leading-relaxed">
          Born from the depths of meme culture, BOLO emerged as the ultimate union of community and creativity. It's not
